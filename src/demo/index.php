...
<head>
    ...
    <script src="./js/script.js?v=<?= filemtime("./js/script.js") ?>" defer></script>
    <script src="./js/accordion.js?v=<?= filemtime("./js/accordion.js") ?>" defer></script>
    <script src="./js/toggle-dark.js?v=<?= filemtime("./js/toggle-dark.js") ?>" defer></script>
    <script src="./js/jscolor.min.js?v=<?= filemtime("./js/jscolor.min.js") ?>" defer></script>
        ...
        <section class="output top-bottom-split" aria-labelledby="preview-title">
            <div class="top">
                ...
                <img
                    ...
                    src="preview.php?user=<?= rawurlencode($GITHUB_OWNER) ?>"
                    width="495"
                    height="195"
                >
